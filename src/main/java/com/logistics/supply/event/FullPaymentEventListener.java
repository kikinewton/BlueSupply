...
public class FullPaymentEventListener {
    ...
    var amountPayable = fullPaymentEvent.getPayment().getGoodsReceivedNote().getInvoiceAmountPayable();
    var totalAmountPaid = paymentService.findTotalPaymentMadeByPurchaseNumber(fullPaymentEvent.getPayment().getPurchaseNumber());
