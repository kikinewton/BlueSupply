...
@Setter
@Getter
public class FloatOrderSpecification implements Specification<FloatOrder> {

  List<SearchCriteria> list;

  public FloatOrderSpecification() {
  ...
  public Predicate toPredicate(
      Root<FloatOrder> root, CriteriaQuery<?> criteriaQuery, CriteriaBuilder builder) {
