...
public class FloatGRNCommentService implements ICommentService<FloatGrnComment, FloatGrnDTO> {
  ...
  @Override
  public FloatGrnComment addComment(FloatGrnComment comment) throws GeneralException {
  ...
  public CommentResponse<FloatGrnDTO> saveFloatGRNComment(
      CommentDTO comment, long floatGrnId, Employee employee) throws GeneralException {
    FloatGRN floatGRN =
        floatGRNRepository
            .findById(floatGrnId)
            .orElseThrow(() -> new GeneralException(FLOAT_GRN_NOT_FOUND, HttpStatus.NOT_FOUND));
