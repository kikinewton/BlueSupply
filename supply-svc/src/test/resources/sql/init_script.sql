...
CREATE TABLE store ( id INTEGER GENERATED BY DEFAULT AS IDENTITY NOT NULL, created_by INTEGER, created_date TIMESTAMP WITHOUT TIME ZONE, last_modified_by INTEGER, last_modified_date TIMESTAMP WITHOUT TIME ZONE, name VARCHAR(50), CONSTRAINT pk_store PRIMARY KEY (id) );
...
INSERT INTO employee (id, changed_default_password, created_at, deleted, email, enabled, first_name, full_name, last_login, last_name, "password", phone_no, updated_at, department_id)
VALUES(3, false, '2023-06-11 09:30:59.179', false, 'chulk@mail.com', true, 'Mark', 'Freeman', NULL, 'Admin', '$2a$10$0YozPuPfeu2pYK5jUEq7Outf.240hM.j/ny.kdyRiNqoAIXP2FRKG', '000000000081', '2023-06-11 09:31:14.899', 11);

INSERT INTO public.employee_role (employee_id, role_id) VALUES(3, 3);

INSERT INTO public.store (created_by, created_date, last_modified_by, last_modified_date, "name") VALUES(1, NOW(), NULL, NULL, 'Engineering store');
